...
import { CREATE_ITEM, CREATE_OPTION, CREATE_PART, CREATE_SECTION, CREATE_TEST, GET_ITEMS, GET_OPTIONS, GET_PARTS, GET_ITEM, GET_SECTIONS, GET_SUBJECTS, GET_TESTS, LOGIN, REGISTER, GET_TEST, ADD_LINK, SUBMIT_TEST, COMPARE_RESULTS, ADD_PART_TO_TEST, GET_TEST_PARTS, GET_FIRST_QUESTION, SUBMIT_ANSWER } from '../actions/ActionTypes';
import { userLogin, userRegister } from './AuthSagas';
import { getItems, itemCreate, getItem, getFirstQuestion, submitAnswer } from './ItemSagas';
...
import { getTest, submitTest, testCreate, compareResults } from './TestSagas';
...
export default function* rootSaga() {
  yield all([
    ...
    takeLatest(COMPARE_RESULTS, compareResults),
    takeLatest(ADD_PART_TO_TEST, testAddPart),
    takeLatest(GET_TEST_PARTS, getTestParts),
    takeLatest(GET_FIRST_QUESTION, getFirstQuestion),
    takeLatest(SUBMIT_ANSWER, submitAnswer)
  ]);
}